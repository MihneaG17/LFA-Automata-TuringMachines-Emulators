...
#functiile TmReadFromFile si removeComments sunt aceleasi ca in emulatorul original (cel care calculeaza suma numerelor), doar functia de emulare va fi putin diferita
...
def TMEmulator(tm_definition, input_str):
    ...
    max_steps=len(input_str)*200+1000 #o limita de siguranta pentru a evita buclele infinite
    current_steps=0
    ...
    while state!=stop_state and current_steps<max_steps:
        ...
        if determined_transition is None:
            ...
            if head>=0:
                ...
                pass #ignoram scrierea daca head < 0
    ...
    #aici vine partea diferita fata de emulatorul pentru adunare - constructia sirului modificat
